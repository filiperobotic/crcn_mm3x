...
pred_csv = "/Users/filipe/Desktop/artigo_micronucleo/predictions_yolo11s.csv"
gt_csv = "/Users/filipe/Desktop/artigo_micronucleo/test.csv"
output_dir = "/Users/filipe/Desktop/artigo_micronucleo/imagens_com_caixas_yolo11s"
...
grouped_pred = pred_df.groupby("file")
image_names = set(gt_df["filename"]).union(pred_df["file"])
